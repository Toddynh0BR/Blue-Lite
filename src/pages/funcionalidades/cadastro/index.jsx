...
import Image1 from "./assets/icon-head-conheca-cadastro-e-controle-de-clientes.png";
import Image2 from "./assets/big-icon-bar-graph.svg";
import Image3 from "./assets/big-icon-despesas-sempre-emdia.svg";
import Image4 from "./assets/big-icon-frente-de-caixa-2.svg";
    ...
    <S.Container>
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          <h2>
          Realize o cadastro e controle de clientes
          </h2>

          <span style={{ fontSize: 16}}>
          Descubra o <strong>controle de clientes</strong> que vai transformar o seu negócio. Diga adeus às <strong>planilhas</strong> e caderninhos, e aproveite a praticidade do Blue Lite! <strong>Baixe agora</strong> e comece a otimizar sua gestão.
          </span>
      ...
      <div className="rest">
       <h3>
 <strong>Conheça </strong> os nossos recursos</h3>

       <div className="cards">
        <div className="card" onClick={() => handleScrollToSection(section1Ref)}>
          <span>
          <strong>Controle </strong> de contas
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section2Ref)}>
          ...
          <span>   
<strong>Receitas </strong>  &  <strong>despesas </strong>
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section3Ref)}>
          ...
          <span>   
          <strong>Sistema de caixa </strong>  &  <strong> PDV </strong>
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section4Ref)}>
          ...
          <span>
         <strong> Venda</strong> & <strong> emissão offline </strong>  &
          </span>
     ...
     <S.Main2 >
      <div className="left">
        <h2>
        Planilhas de excel e fichas de cadastro <br /> manuais são  <strong>coisas do passado.</strong>
        </h2>
      ...
      <div className="right">
      <p>Será que vale a pena continuar gerenciando sua empresa e o cadastro de clientes por meio de <strong>planilhas</strong>? <br /><br />
       Baixe gratuitamente o Blue Lite, uma ferramenta completa para gerenciar lojas e empresas prestadoras de serviços. Com o Blue Lite, você pode manter todos os <strong>cadastros atualizados</strong>, gerar vendas, emitir notas, controlar estoque e ainda garantir que seu <strong>fluxo de caixa</strong> esteja <strong>sempre em dia</strong>!</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
       Controle de contas a  <strong>  receber e a pagar</strong>
       </h3>

       <p>Com o Blue Lite, você terá <strong>controle total</strong> sobre seus recebimentos e clientes inadimplentes. Além disso, é possível <strong>exportar</strong> seus recebimentos em aberto para arquivos nos formatos PDF ou Excel. Os recursos oferecidos proporcionam um <strong>controle rigoroso</strong> de todas as contas e resultados.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <h3>
       Classifique suas <strong> receitas e despesas</strong>
       </h3>

       <p>Com o Blue Lite, elabore a <strong>escrituração financeira</strong> da sua empresa através da <strong>categorização</strong> das receitas e despesas. Mantenha suas informações organizadas, proporcionando uma <strong>visualização clara</strong> e objetiva de todos os dados financeiros.</p>
     ...
     <S.Main4 ref={section3Ref}>
      <div  className="left">
       <h3><strong>Sistema de caixa e PDV</strong>
       </h3>

       <p>Com o Blue Lite, o seu <strong>programa de caixa de loja</strong> conta com teclas de <strong>acesso rápido</strong>, tornando o processo de venda ainda mais ágil. Nele, você pode registrar vendas e controlar seu <strong>fluxo de caixa</strong> de forma prática e eficiente.</p>
<p>Através do nosso sistema de caixa para lojas, você pode adicionar diversas <strong>formas de pagamento</strong> em uma única venda, oferecendo um leque de opções mais amplo para garantir registros precisos.</p>
     ...
     <S.Main4 ref={section4Ref}>
      ...
      <div className="right">
       ...
       <h3>
       Venda e emissão mesmo <strong> sem acesso à internet </strong>
       </h3>

       <p>O Blue Lite oferece um <strong>sistema de contingência</strong> que garante que você continue trabalhando sem interrupções, mesmo em caso de imprevistos, como problemas na conexão com a <strong>internet</strong>.</p>

<p>Com isso, você não precisa parar o que está fazendo e pode seguir <strong>faturando normalmente</strong>!</p>
