...
import Image3 from "./assets/big-icon-bar-graph.svg";
import Image4 from "./assets/big-icon-despesas-sempre-emdia.svg";
import Image5 from "./assets/big-icon-invoice-2.svg";
import Image6 from "./assets/big-icon-no-internet-2.svg";

import i1 from "./assets/icon-Page-1.svg";
import i2 from "./assets/icone-bar-graph.svg";
import i3 from "./assets/icon-gestao-empresarial.svg";
import i4 from "./assets/icon-invoice-2.svg";
import i5 from "./assets/icone-no-internet.svg";
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          <span>
          <strong>Controle o seu caixa </strong> com o nosso  <br /> sistema, baixe agora e comprove!
          </span>
 ...
 <strong>Conheça </strong>  os nossos recursos</h3>
       ...
       <div className="cards">
        <div className="card" onClick={() => handleScrollToSection(section1Ref)}>
          <span>
          <strong>PDV </strong>Rápido e Fácil 
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section2Ref)}>
          <span>
          <strong>Operações</strong> de Caixa 
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section3Ref)}>
          ...
          <span>   
<strong>Gestão </strong>  de Estoque
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section4Ref)}>
          ...
          <span>   
<strong>Emissão </strong> de notas 
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section5Ref)}>
          ...
          <span>
         <strong> Online  </strong> e<strong>Offline</strong>
          </span>
...
Está procurando um <strong> sistema <br /> de controle de caixa ?</strong>
        </h2>
      ...
      <div className="right">
      <p>Você está com sorte! <br /> Com o <strong>Blue Lite</strong>, você tem um controle total sobre a gestão do seu caixa. <br /> Gerencie suas <strong>contas a pagar</strong> e <strong>a receber</strong>, emita notas e cupons fiscais sem limitações, e acesse os dados dos seus clientes e vendas a qualquer momento. O <strong>Blue Lite</strong> é um sistema intuitivo, fácil de usar e ainda funciona sem conexão com a internet!</p>
     ...
     <S.Main4 ref={section1Ref} style={{ backgroundColor: '#e7e7e7'}}>
      <div  className="left">
       <h3>
       Registre suas vendas de <strong> forma mais rápida </strong> através do nosso PDV
       </h3>

       <p>O <strong>Blue Lite</strong> oferece um PDV (Frente de Caixa) com uma interface <strong>intuitiva</strong>, facilitando o manuseio rápido através das teclas de atalho no seu teclado. Isso proporciona <strong>mais agilidade</strong> no seu dia a dia, reduzindo a dependência do uso do mouse.</p>

<p>Basta selecionar entre as opções e o sistema automaticamente o direcionará para a tela apropriada.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <p>Com o <strong>Blue Lite</strong>, você pode informar o valor disponível em seu caixa ao iniciar o expediente e conferir todos os dados ao realizar o <strong>fechamento</strong>. Além disso, é possível realizar o <strong>reforço</strong> e a <strong>sangria</strong> do caixa com apenas alguns cliques, garantindo mais praticidade no seu controle financeiro.</p>
     ...
     <S.Main4 ref={section3Ref}>
      <div  className="left">
       <h3>
       Sistema integrado de  <strong> gestão de estoque</strong>
       </h3>

       <p>Realize suas <strong>vendas</strong> e gerencie seu <strong>estoque</strong> com facilidade. O <strong>Blue Lite</strong> integra o módulo de vendas diretamente ao seu estoque, eliminando a necessidade de ajustes manuais a cada transação. Isso proporciona muito mais <strong>agilidade</strong> no seu dia a dia.</p>
     ...
     <S.Main4 ref={section4Ref}>
      ...
      <div className="right">
       ...
       <h3>
        <strong> Emita quantas notas fiscais quiser!</strong>
       </h3>

       <p>O <strong>Blue Lite</strong> não possui pacotes que limitam a quantidade de notas mensais. Com ele, você pode emitir quantas notas forem necessárias, e o melhor de tudo, você não precisará gastar nada a mais por isso!</p>
