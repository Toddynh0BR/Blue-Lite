...
import Image1 from "./assets/icon-head-controle-de-os.png";
import Image2 from "./assets/big-icon-gestao-financeiro.svg";
import Image3 from "./assets/big-icon-tecnicos.svg";
import Image4 from "./assets/big-icon-controle-de-estoque.svg";


import i1 from "./assets/icon-gestao-financeiro.svg";
import i2 from "./assets/icon-tecnicos.svg";
import i3 from "./assets/icon-controle-de-estoque.svg";
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          <span >
          Realize o <strong> controle de Ordens de Serviços </strong> com o nosso sistema fácil de usar!
          </span>
 ...
 <strong>Conheça </strong> os nossos recursos</h3>
       ...
       <div className="cards">
        <div className="card" onClick={() => handleScrollToSection(section1Ref)}>
          <span>
          <strong>Gestão</strong > Financeiro
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section2Ref)}>
          ...
          <span>   
<strong>Cadastro </strong>  de Técnicos
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section3Ref)}>
          ...
          <span>   
          <strong>Controle</strong>   de Estoque
          </span>
     ...
     <S.Main2 style={{ height: 'fit-content'}}>
      <div className="left">
        <h2>
        Está <strong> procurando </strong> uma planilha Excel de controle de OS?
        </h2>
      ...
      <div className="right">
      <p>Se você chegou aqui buscando uma <strong>planilha Excel</strong> para o controle de ordens de serviço, provavelmente já entende a importância de ter um acompanhamento detalhado das prestações geradas. No entanto, o que você precisa saber é que a utilização de planilhas Excel não é a melhor escolha para essa tarefa. <br /><br />
O Blue Lite é uma ferramenta <strong>fácil de usar</strong> e adequada a diversos tipos de serviços. Ele oferece <strong>integração automática</strong> com o estoque e com o módulo financeiro para o controle de todas as contas a receber.<br /><br />
Com um sistema de controle de ordens de serviço, você não precisa perder tempo procurando informações essenciais para o seu negócio, pois todos os módulos estão <strong>integrados automaticamente</strong>.<br /><br />
É fundamental ter um bom <strong>controle de ordens de serviço</strong>, pois isso oferece uma visão clara e ampla da situação da sua empresa.</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
      <strong>Gerencie seus dados financeiros</strong>
       </h3>
       <p>Basta registrar sua ordem de serviço na plataforma e, ao finalizar a execução do serviço, todas as informações serão automaticamente enviadas ao módulo financeiro. Isso traz muito mais <strong>praticidade</strong> para o <strong>controle</strong> e gerenciamento das operações da sua empresa.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <p>Com o cadastro de técnicos, é possível identificar de forma <strong>rápida</strong> qual colaborador está encarregado de cada serviço, além de visualizar os <strong>equipamentos</strong> utilizados e o <strong>laudo final</strong> do técnico responsável.</p>
     ...
     <S.Main4 ref={section3Ref}>
      <div  className="left">
       <h3><strong>Controle de Estoque</strong>
       </h3>

       <p>Através do sistema de gerenciamento de OS, é possível monitorar todos os <strong>produtos vendidos</strong> ou utilizados durante a prestação de serviços. Dessa forma, você consegue acompanhar todos os <strong>gastos</strong> gerados e ter uma visão <strong>clara</strong> sobre seus lucros.</p>
