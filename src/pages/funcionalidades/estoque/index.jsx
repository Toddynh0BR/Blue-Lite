...
import i1 from "./assets/barcode-scanner.svg";
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          O Blue Lite é um programa para <strong> controle de estoque  </strong> que suporta leitor de código de barras.
          </span>
 ...
 <strong>Conheça </strong> os nossos recursos</h3>
       ...
       <div className="cards">
        <div className="card" onClick={() => handleScrollToSection(section1Ref)}>
          ...
          <strong>Leitor de código de barra</strong > 
          </span>
...
<strong>Dashboard </strong> 
     ...
     <S.Main2 style={{ height: 'fit-content'}}>
      <div className="left">
        <h2>
        Você está <strong> procurando </strong>  procurando por uma planilha para controle de estoque?
        </h2>
      ...
      <div className="right">
      <p>Após conhecer o <strong>Blue Lite</strong>, você nunca mais vai querer usar planilhas manuais! O módulo de <strong>vendas</strong> e o dashboard do Mercado Livre são totalmente integrados ao seu módulo de <strong>estoque</strong>, garantindo que você não perca tempo duplicando informações em diferentes telas.
      <br /><br />
      O <strong>Blue Lite</strong> é o primeiro passo para quem quer aprimorar sua gestão e aumentar os resultados! Com ele, você poderá acessar as funcionalidades essenciais, tanto online quanto offline.</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
       Controle de Estoque com  <strong> Código de Barras</strong>
       </h3>

       <p>No cadastro de produtos do <strong>Blue Lite</strong>, há um campo exclusivo para o <strong>código de barras</strong>, permitindo que você gerencie e busque seus itens de forma muito mais ágil. Ao utilizar o <strong>leitor de código de barras</strong> durante a venda, basta registrar a forma de pagamento e, ao concluir a transação, o estoque será atualizado automaticamente.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <h3>
       Dashboard de <strong> Controle de Estoque</strong>
       </h3>

       <p>Através do nosso <strong>dashboard</strong>, você pode atualizar os dados do seu estoque de maneira rápida e prática, com apenas alguns cliques. Basta ajustar as quantidades de produtos e <strong>salvar as alterações</strong> para manter tudo organizado. <strong>Sem complicações</strong>, você tem total controle do seu inventário!</p>
