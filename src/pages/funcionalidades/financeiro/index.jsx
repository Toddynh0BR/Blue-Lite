...
import Image5 from "./assets/big-icon-despesas-sempre-emdia.svg";

import i1 from "./assets/icon-contas-a-pagar.svg";
import i2 from "./assets/big-icon-contas-a-pagar.svg";
import i3 from "./assets/icon-nao-perca-vendas.svg";
import i4 from "./assets/icon-gestao-empresarial.svg";
  ...
  return (
    <S.Container>
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          <span style={{ fontSize: 18}}>Usar um sistema eficiente para gerenciar as <br /> finanças do seu negócio não precisa  mais ser um desafio ou gerar  problemas no seu <strong>fluxo de caixa</strong>. <br /> Simplifique o controle financeiro da sua empresa com o <strong>Blue Lite</strong>! <br /> Este é o recurso ideal para quem busca praticidade e <br /> economia ao lidar com <strong>gestão financeira</strong>.</span>
      ...
      <div className="rest">
       <h3>
       <strong> Conheça </strong> os nossos recursos!
       </h3>
       ...
       <div className="cards">
        ...
        <div className="card" onClick={() => handleScrollToSection(section3Ref)}>
          ...
          <span>   
          <strong>Não perca Vendas</strong>
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section4Ref)}>
          ...
          <span>
          <strong>Controle e Gestão</strong>
          </span>
     ...
     <S.Main2 >
      <div className="left">
        <h2>
        Você <strong> ainda sofre </strong> com planilhas para controle de vendas?
        </h2>

        <Link to="/baixar-blue-lite">
         <button>
         Experimente o Blue Lite
         </button>
        </Link>
      </div>

      <div className="right">
      <p>Com o nosso Sistema de Gestão e Vendas desenvolvido especialmente para Micro e Pequenas Empresas, o crescimento do seu negócio não terá limites. Por meio de <strong>telas intuitivas</strong> e funcionalidades que atendem diversos tipos de empreendimentos, você pode cadastrar produtos simples ou com variações, gerenciar o <strong>fluxo de caixa</strong> (contas a pagar e a receber), emitir boletos e até gerar <strong>notas fiscais e cupons fiscais</strong>.  
<br /><br />
O Blue Lite é a escolha ideal para quem está começando ou deseja simplificar as tarefas do dia a dia. Faça o download gratuito para explorar os recursos básicos e, quando estiver pronto para expandir, torne-se um cliente Starter. Assim, terá acesso a funcionalidades avançadas como o App de Vendas para Celular e a Loja Virtual. A sua empresa merece essa evolução!</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
      <strong> Controle de contas a pagar</strong>
       </h3>

       <p>No Blue Lite, você pode registrar e acompanhar todas as suas <strong>despesas e custos</strong> de maneira simples e ágil. Isso proporciona muito mais <strong>facilidade</strong> para o controle e gestão das <strong>operações financeiras</strong> da sua empresa.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <h3>
     <strong>Controle de Contas a Receber</strong>
       </h3>

       <p>Com o Blue Lite, você pode registrar e monitorar todas as suas <strong>despesas</strong> e <strong>custos</strong> de maneira rápida e eficiente. O sistema oferece muito mais <strong>praticidade</strong> para gerenciar e controlar as operações financeiras da sua empresa.</p>
     ...
     <S.Main4 ref={section3Ref}>
      <div  className="left">
       <h3>
      <strong>Não perca Nenhuma Venda</strong>
       </h3>

       <p>Com o Blue Lite, você pode continuar realizando suas <strong>vendas</strong>, mesmo que sua empresa enfrente problemas de conexão com a internet. Graças ao nosso sistema de <strong>contingência</strong>, é possível vender e emitir cupons fiscais sem dificuldades. Além disso, tudo é totalmente integrado, eliminando a necessidade de registrar manualmente cada informação. Você conta com um processo <strong>automatizado</strong> e muito mais eficiente.</p>
     ...
     <S.Main4 ref={section4Ref}>
      ...
      <div className="right">
       ...
       <h3>
       <strong> Controle e Gerencie toda a sua Empresa</strong>
       </h3>

       <p>Além de oferecer controle financeiro e suporte para geração de <strong>vendas</strong>, o Blue Lite conta com diversos outros <strong>recursos</strong> que vão muito além do que uma simples planilha Excel pode oferecer. Com ele, você pode gerenciar sua empresa de <strong>forma completa</strong> e eficiente.</p>
       ...
       <ul>
        <li 
         ...
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}>PDV Grátis com NFC-e
          <br /> e CF-e SAT Offline
         </p>
        </li>
        ...
        <li 
         style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}>Cadastros Básicos</p>
        </li>
       </ul>
       ...
       <ul>
        <li 
         style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}>Contas a Pagar e Receber</p>
        </li>

        <li 
         style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}> Emissão de notas fiscais</p>
        </li>

        <li 
         style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}>Integrado e marketplaces</p>
        </li>
       </ul>
       ...
       <ul>
        <li 
         style={{ display: 'flex', alignItems: 'center', gap: 5, marginBottom: 10 }}>
         <b style={{ color: 'rgb(9, 194, 9)', fontSize: 20}}>•</b>
         <p style={{ fontSize: 17, fontWeight: 'normal', color: '#363636'}}>
         Pedidos e Orçamentos</p>
        </li>
