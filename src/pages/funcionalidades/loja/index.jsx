...
import Image3 from "./assets/big-icon-online.svg";
import Image4 from "./assets/big-icon-bar-graph.svg";
import Image5 from "./assets/big-icon-no-internet-2.svg";

import i1 from "./assets/sell.svg";
import i2 from "./assets/icone-online.svg";
import i3 from "./assets/icone-bar-graph.svg";
import i4 from "./assets/icone-no-internet.svg";
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          <span>
          Conheça o <strong> melhor sistema </strong> para lojas do país!
          </span>
...
Ferramentas completas para ter seu <strong> fluxo de caixa sempre em dia!</strong></h3>
       ...
       <div className="cards">
        <div className="card" onClick={() => handleScrollToSection(section1Ref)}>
          <span>
          <strong>PDV </strong> Fácil & Rápido
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section2Ref)}>
          ...
          <span>   
<strong>Emissor  </strong> de Cupons e Notas
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section3Ref)}>
          ...
          <span>   
<strong>Controle</strong> de Caixa Diário
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section4Ref)}>
          ...
          <span>
         <strong> Sistema de Gestão</strong>  Offline
          </span>
     ...
     <S.Main2 >
      <div className="left">
        <h2>
<strong>
Sistema com PDV pra loja.
</strong> <br />
Emissão de NF-e, NFC-e e CF-e SAT,  funciona <u> até sem internet.</u>
        </h2>
      ...
      <div className="right">
      <p>O <strong>Blue Lite</strong> oferece um sistema completo para lojas, proporcionando muito mais <strong>agilidade</strong> e <strong>eficiência</strong> para o seu comércio! <br /><br />
Comece a aumentar seus lucros utilizando o <strong>Blue Lite</strong> na sua empresa. Ele conta com uma <strong>frente de caixa eficiente</strong> que amplia suas oportunidades de vendas. Com ele, você terá acesso ao fechamento do caixa, exibindo todas as operações realizadas no dia de maneira rápida e prática.<br /><br />
Evite filas para pagamento, controle o caixa diário e melhore o atendimento ao seu cliente.<br /><br />
Entre as diversas funcionalidades do <strong>Blue Lite</strong>, está um programa para loja que é prático e intuitivo.</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
       PDV Frente de Caixa  <strong> fácil & rápido</strong>
       </h3>

       <p>No módulo de frente de caixa (PDV) do <strong>Blue Lite</strong>, você pode adicionar produtos rapidamente utilizando o código de barras. Basta passar o leitor sobre o produto, ajustar a quantidade se necessário, informar a forma de pagamento do seu cliente e concluir a venda, de forma simples e rápida!</p>
<p>Se o valor pago pelo seu cliente for maior do que o total da venda, o <strong>Blue Lite</strong> calculará e exibirá automaticamente o valor do <strong>troco</strong>.</p>
     ...
     <S.Main4 ref={section2Ref}>
      ...
      <div className="right">
       ...
       <p>Com o <strong>Blue Lite</strong>, você pode utilizar o emissor de <strong>Nota Fiscal de Consumidor Eletrônica (NFC-e)</strong> ou o <strong>Cupom Fiscal Eletrônico (CF-e SAT)</strong>, que são emitidos através do SAT (Sistema Autenticador e Transmissor de Cupons Fiscais Eletrônicos) para o estado de São Paulo. Esses cupons substituem os antigos equipamentos ECF (Emissor de Cupom Fiscal), eliminando a necessidade de um alto investimento nesses dispositivos.</p>
<p>Com isso, você ganha muito mais <strong>praticidade</strong> e <strong>economia</strong>, já que o <strong>Blue Lite</strong> funciona perfeitamente mesmo sem conexão à internet!</p>
     ...
     <S.Main4 ref={section3Ref}>
      <div  className="left">
       <h3>
       Controle de <strong> Caixa diário</strong>
       </h3>

       <p>Com o <strong>Blue Lite</strong>, você pode facilmente controlar o <strong>caixa diário</strong> da sua loja. Ao iniciar o dia, basta abrir o caixa e informar o <strong>saldo inicial</strong>, além de adicionar as diferentes formas de pagamento. O sistema irá automaticamente somar as vendas e os reforços, e subtrair as sangrias ao longo do dia.</p>
<p>Ao final, basta fechar o caixa do PDV e o <strong>Blue Lite</strong> calculará automaticamente o valor que deverá estar disponível, facilitando a conferência do caixa no final do expediente.</p>
     ...
     <S.Main4 ref={section4Ref}>
      ...
      <div className="right">
       ...
       <h3>
       Sistema de Gestão Offline, 
<strong> pra você vender sempre!</strong>
       </h3>

       <p>Com o <strong>Blue Lite</strong>, você não precisa se preocupar com a falta de conexão à internet. Mesmo offline, o sistema irá emitir o <strong>cupom fiscal</strong> em contingência, permitindo que o seu cliente não precise esperar para receber o comprovante ou retornar em outro momento.</p>
<p>Isso significa que você não perde <strong>vendas nem dinheiro</strong>, independentemente da sua conexão. Não deixe que a falta de internet atrapalhe seu atendimento – baixe agora o <strong>Blue Lite</strong>, o melhor sistema para lojas, e nunca mais enfrente filas gigantescas!</p>
