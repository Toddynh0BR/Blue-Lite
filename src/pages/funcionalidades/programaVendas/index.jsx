...
import Image2 from "./assets/big-icon-controle-de-estoque.svg";
import Image3 from "./assets/big-icon-frente-de-caixa-2.svg";
import Image4 from "./assets/big-icon-teclado.svg";
import Image5 from "./assets/big-icon-danfe-2.svg";
import Image6 from "./assets/leitor-codigo-barras.svg";
import Image7 from "./assets/venda-financeiro.svg";

import i1 from "./assets/icon-controle-de-estoque.svg";
import i2 from "./assets/icon-Page-1.svg";
import i3 from "./assets/icon-teclado.svg";
import i4 from "./assets/icon-slip.svg";
import i5 from "./assets/barcode-scanner.svg";
import i6 from "./assets/integrity.svg";

export function ProgramaVendas() {
  ...
  return (
    <S.Container>
     ...
     <S.Main>
      <div className="text">
        <div className="texts">
          ...
          <span style={{ fontSize: 18}}>O nosso software PDV (Frente de Caixa) do Blue Lite oferece uma <strong>interface intuitiva</strong>, permitindo um <strong>manuseio ágil</strong> com o uso de <strong>teclas de atalho</strong> no teclado.</span>
      ...
      <div className="rest">
       ...
       <div className="cards">
        ...
        <div className="card" onClick={() => handleScrollToSection(section2Ref)}>
          ...
          <span>   
          <strong>Operações de Caixa</strong>
          </span>
        ...
        <div className="card" onClick={() => handleScrollToSection(section4Ref)}>
          ...
          <span>
          <strong>Emissão de Notas e Cupons</strong>
          </span>
       ...
       <div className="card" onClick={() => handleScrollToSection(section6Ref)}>
         ...
         <span>
         <strong>Integrado ao Financeiro</strong>
         </span>
     ...
     <S.Main2 >
      ...
      <div className="right">
      <p>O sistema PDV do Blue Lite foi desenvolvido para funcionar mesmo que o computador esteja enfrentando problemas de <strong>conexão com a internet</strong>. Dessa forma, você não precisa interromper suas <strong>vendas</strong> devido a questões técnicas e pode continuar <strong>gerando lucro</strong> sem complicações.</p>
     ...
     <S.Main4 ref={section1Ref}>
      <div  className="left">
       <h3>
      <strong> Estoque e Automação Industrial</strong>
       </h3>
       <p>Realize suas <strong>vendas</strong> e gerencie seu <strong>estoque</strong> de forma descomplicada. Com o Blue Lite, o módulo de vendas é integrado ao estoque, eliminando a necessidade de ajustes manuais a cada venda. Isso traz muito mais <strong>agilidade</strong> para a sua rotina diária.</p>
     ...
     <strong>Operações de Caixa</strong>
       ...
       <p>Informe o <strong>valor disponível</strong> em seu caixa ao iniciar o expediente e consulte todos os dados no momento do <strong>fechamento</strong>. Com o Blue Lite, você também pode realizar <strong>reforços</strong> e sangrias no caixa de forma rápida e prática, com apenas alguns cliques.</p>

      </div>
     </S.Main4>

     <S.Main4 style={{ backgroundColor: '#e7e7e7'}} ref={section3Ref}>
      <div  className="left">
       <h3>
      <strong>Teclas de Atalho</strong>
       </h3>
       <p>Aproveite as nossas <strong>teclas de acesso rápido</strong> para adicionar produtos, cadastrar clientes, definir formas de pagamento e emitir o <strong>cupom fiscal</strong>, tudo de forma ágil. Com o Blue Lite, você pode concluir suas <strong>vendas</strong> em questão de segundos!</p>
     ...
     <S.Main4 style={{ backgroundColor: '#e7e7e7'}} ref={section4Ref}>
      <div  className="left">
      <img src={Image5} alt="" />
      </div>
      ...
      <div className="right">
       ...
       <h3>
       <strong>Emissão de Notas e Cupons Fiscais</strong>
       </h3>
       <p>O Blue Lite oferece a emissão de <strong>notas</strong> e <strong>cupons fiscais</strong> de forma prática. Basta selecionar o tipo de <strong>documento fiscal</strong> desejado diretamente na venda e realizar a emissão de forma rápida, sem complicação!</p>
     ...
     <S.Main4  ref={section5Ref}>
      ...
      <strong>Leitor de Código de Barras</strong>
       ...
       <p>Com o leitor de <strong>código de barras</strong>, o Blue Lite permite agilizar a inclusão de produtos na venda, tornando o seu <strong>atendimento</strong> ainda mais rápido! Assim, você economiza <strong>tempo</strong> e <strong>dinheiro</strong>.</p>
     ...
     <S.Main4 ref={section6Ref}>
      ...
      <div className="right">
       ...
       <h3>
       <strong>Integrado ao Módulo Financeiro</strong>
       </h3>
       <p>Com o Blue Lite, todas as suas <strong>vendas</strong> são registradas automaticamente no <strong>financeiro</strong>, permitindo que você continue suas atividades sem precisar interromper o que está fazendo ou abrir outro sistema para lançar o que foi recebido. Tudo é feito de forma <strong>automática</strong> e eficiente.</p>
