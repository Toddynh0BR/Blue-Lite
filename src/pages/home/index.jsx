...
import f1 from "./assets/features-icon-1.svg";
import f2 from "./assets/features-icon-2.svg";
import f3 from "./assets/features-icon-3.svg";
import f4 from "./assets/features-icon-4.svg";
import f5 from "./assets/features-icon-5.svg";

import l1 from "./assets/list-features-icon-1.svg";
import l2 from "./assets/list-features-icon-2.svg";
import l3 from "./assets/list-features-icon-3.svg";
import l4 from "./assets/list-features-icon-4.svg";
  ...
  useEffect(() => {
    ...
    return(
     <S.Container>
      ...
      <S.Main>
       <h2>
        <strong>Comece a emitir notas facilmente, gerenciar seu estoque, financeiro, compras </strong> e muito mais.
       </h2>

       <span>
       Tudo isso na versão gratuita do Blue Lite. <strong> Baixe agora mesmo!</strong>
       </span>

       <div className="buttons">
        <Link to="/baixar-blue-lite">
         <button>
            <IoMdDownload size={25} color="#fff" />
            Baixe a versão <strong>gratuita</strong>
         </button>
        </Link>

        <Link to="/planos">
         <div className="button">
            Conheça a Versão <strong> Premium</strong>
         </div>
        </Link>
       </div>
       ...
       <div className="bottom">
        ...
        <h3>
        Ferramentas adaptadas para <strong> diferentes segmentos de negócios</strong>
        </h3>
       </div>
      </S.Main>
...
Orçamentos
       ...
       <div className="grid">
        <div className="box bottom">
         ...
         <p>
Um sistema projetado para facilitar suas <strong>vendas</strong>. Cadastre seus produtos, conecte um <strong>leitor de código de barras</strong> e comece a vender. O <strong>PDV Frente de Caixa</strong> do <strong>Blue Lite</strong> funciona tanto online quanto offline, permitindo a emissão de notas e cupons fiscais de forma prática.
</p>
        ...
        <div className="box left bottom">
         ...
         <p>
Cadastre todos os seus <strong>produtos</strong>, controle as <strong>quantidades em estoque</strong>, acompanhe o ranking dos itens mais vendidos e receba alertas quando algo estiver acabando. Mantenha sua <strong>gestão de estoque</strong> em dia e totalmente integrada ao seu financeiro.
</p>
        ...
        <div className="box bottom">
         ...
         <p>
Precisa emitir <strong>notas fiscais de venda</strong>? NF-e, NFC-e ou CF-e SAT? Com o <strong>Blue Lite</strong> você pode! Todas as <strong>configurações fiscais</strong> são simples e intuitivas, permitindo que você concentre seus esforços em atender seus clientes e fazer sua empresa crescer!
<br />
<b>*Documentos Fiscais de venda, notas de devolução não incluso.</b>
         </p>
        ...
        <div className="box left bottom">
         ...
         <p>
Você que possui uma empresa prestadora de <strong>serviços</strong> terá à disposição um modelo padrão de <strong>orçamentos</strong> para imprimir ou enviar aos seus clientes. Além disso, poderá cadastrar todos os serviços oferecidos e gerar ilimitadas <strong>ordens de serviço</strong>!
</p>
        ...
        <div className="box">
         ...
         <p>
<strong>Planejamento</strong>, <strong>organização</strong> e informações seguras. Para isso, nada melhor do que contar com relatórios completos do seu negócio. Aqui você encontra relatórios de <strong>Estoque</strong>, Financeiro e Gestão Fiscal, garantindo uma visão ampla sobre os seus processos.
</p>
        ...
        <div className="box left">
         ...
         <p>
Gere lançamentos financeiros a partir de <strong>vendas</strong>, controle o <strong>calendário de pagamentos</strong>, emita boletos e acompanhe todas as suas <strong>receitas e despesas</strong>. Tudo com listagens organizadas e um gráfico de fluxo de caixa para facilitar sua gestão.
</p>
      ...
      <S.Main3>
        <div className="left">
         <h3>
         <strong>Integre com as maiores </strong> plataformas de e-commerce e marketplaces do país utilizando o Blue Lite.
         </h3>
         ...
         <div className="buttons">
           <Link to="/baixar-blue-lite">
            <button>
             <IoRocketSharp/>
             <p>
             Comece a <strong> vender online</strong>
             </p>
            </button>
           </Link>
 
           <Link to="/central-de-integracoes">
