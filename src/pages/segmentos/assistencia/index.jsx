...
import Background from "../assets/image-top-sige-lite-assistencia-tecnica.png";
import { useState, useRef, useEffect } from "react";

import Image1 from "../assets/sistema-para-assistencia-tecnica.svg";
import Image2 from "../assets/gestao-de-servicos.svg";
import Image3 from "../assets/controle-de-estoque-assistencia.svg";
import Image4 from "../assets/gestao-financeira-minimercados.svg";
    ...
    return (
        <S.Container data-subHeader={isOutOfView}>
         ...
         <S.Main id="myDiv">
          ...
          <div className="left">
           <h1>
           Mais que um <br /> Sistema de Gestão <br /><strong>para sua Assistência Técnica!</strong>
           </h1>

           <ul>
            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>PDV </strong>móvel;</p>
            </li>

            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>Loja Virtual</strong>   Própria; </p>
            </li>

            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>Controle de Ordens  </strong>  de Serviço.</p>
            </li>
           </ul>
...
Tudo o que a sua Assistência Técnica precisa, o Blue Lite tem!
            </h2>

            <p>Precisando conciliar a venda de produtos com a oferta de serviços? Se você tem uma loja de informática e faz assistência técnica, saiba que o <strong>Blue Lite</strong> reúne os melhores recursos para gerenciar suas OS, atender clientes, controlar financeiro e vender o quanto quiser!</p>

<p>Desenvolvido para atender às demandas das micro e pequenas empresas, o <strong>Blue Lite</strong> tornou-se a aposta de mais de 200 mil empreendedores em todo o Brasil que decidiram descomplicar a gestão empresarial e apostar em ferramentas para faturar mais. <strong>Tudo o que a sua Assistência Técnica precisa, o Blue Lite tem!</strong></p>
         ...
         <img src={Image2} alt="" />
          ...
          <div className="left">
            <span>Quer gerenciar serviços?</span>
            <h2>
            Nós facilitamos o funcionamento do seu negócio!
            </h2>
            ...
            <p>Gerar Ordens de Serviço é uma necessidade de prestadores de qualquer segmento. Se a sua oficina mecânica ainda não tem uma solução que automatize o preenchimento e dê mais velocidade a essa tarefa, você está <strong>perdendo dinheiro</strong>. Venha para o <strong>Blue Lite</strong> e entenda porque milhares de prestadores de serviço se tornaram clientes Starter!</p>

            <h3>
            Cadastro de Clientes e Fornecedores
            </h3>

            <p>Você ainda controla a sua carteira de clientes em uma planilha excel? Com o cadastro de pessoas físicas e jurídicas do <strong>Blue Lite</strong> você tem muito mais eficiência na busca de clientes registrados ou dos seus fornecedores. Com esse recurso você pode <strong>vincular clientes às vendas</strong> ou <strong>fornecedores aos pagamentos</strong>, de forma simples e rápida.</p>
          ...
          <div className="columns">
           ...
           <div className="column c3">
            <div className="topic">
             ...
             <p>Não bastassem todas as funcionalidades nativas do <strong>Blue Lite</strong>, você pode contar com nossas integrações com a B2W Marketplace ou ainda com o Mercado Livre. Assim, <strong>anunciar as roupas e acessórios</strong> da sua loja fica muito mais fácil. Em um painel exclusivo, você <strong>acompanha seus anúncios</strong>, responde todas as perguntas recebidas, envia mensagens automáticas e acompanha o status de todas as suas vendas e recebimentos.</p>
          ...
          <div className="rest" ref={section2Ref}>
            ...
            <ul>
             ...
             <li>
              ...
              <p>Se além da venda de peças automotivas, você também trabalha com a <strong>prestação de serviços</strong>, saiba que clientes da versão premium podem contratar esse módulo à parte, como um adicional que complementa toda a sua <strong>gestão fiscal</strong>. Assim, sua empresa estará sempre em dia com o Fisco e você com tranquilidade de acessar as informações do seu negócio a qualquer tempo.</p>
         ...
         <S.Main4 ref={section4Ref} style={{ background: 'none'}}>
          ...
          <div className="left">
            ...
            Ajudamos você a cuidar do seu caixa, para a sua Assistência Técnica crescer!
            </h2>
          ...
          <p style={{ color: '#363636'}}>O <strong>Blue Lite</strong> possui um Frente de Caixa para lojas dos mais diferentes segmentos, funcionando até mesmo sem internet! Nele, é possível registrar suas vendas e controlar o seu fluxo de caixa de forma rápida, prática e eficiente. E você ainda tem a facilidade de utilizar qualquer leitor de código de barras.</p>
