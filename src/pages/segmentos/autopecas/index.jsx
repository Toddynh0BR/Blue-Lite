...
import Background from "../assets/image-top-sige-lite-minimercados.png";
import { useState, useRef, useEffect } from "react";

import Image1 from "../assets/sistema-para-autopecas.svg";
import Image2 from "../assets/gestao-de-sevicos-autopecas.svg";
import Image3 from "../assets/controle-de-estoque-autopecas.svg";
    ...
    return (
        <S.Container data-subHeader={isOutOfView}>
         ...
         <S.Main id="myDiv">
          ...
          <div className="left">
           <h1>
           Mais que um <br /> Sistema de Gestão <br /> <strong> para sua Autopeças!</strong>
           </h1>

           <ul>
            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>Boletos </strong>automáticos;</p>
         ...
         <S.Main2>
          <div className="left">
            <h2>
            Tudo o que a sua Autopeças precisa, o Blue Lite tem!
            </h2>

            <p>Se você tem uma loja de autopeças e atua no conserto e manutenção de veículos, saiba que o <strong>Blue Lite</strong> possui os melhores recursos para gerenciar suas OS, atender clientes, controlar financeiro e <strong>vender o quanto quiser</strong>! </p>

<p>Desenvolvido para atender às demandas das micro e pequenas empresas, o <strong>Blue Lite</strong> tornou-se a aposta de mais de 200 mil empreendedores em todo o Brasil que decidiram descomplicar a gestão empresarial e apostar em ferramentas para <strong>faturar mais</strong>. Tudo o que a sua Assistência Técnica precisa, o <strong>Blue Lite</strong> tem!</p>
         ...
         <img src={Image2} alt="" />
          ...
          <div className="left">
            ...
            <h2>
           Descomplique a rotina da sua Autopeças!
            </h2>
