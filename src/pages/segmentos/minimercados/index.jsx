...
import Image1 from "../assets/sistema-para-minimercados.svg";
import Image2 from "../assets/controle-de-estoque-minimercados.svg";
    ...
    return (
        <S.Container data-subHeader={isOutOfView}>
         ...
         <S.Main id="myDiv">
          ...
          <div className="left">
           <h1>
           Mais que um <br /> Sistema frente de <br /> caixa <strong> para o seu <br /> minimercado!</strong>
           </h1>

           <ul>
            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>Frente de Caixa </strong>no celular;</p>
            </li>

            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p><strong>Loja Online  </strong>  com Delivery;</p>
            </li>
         ...
         <S.Main2>
          <div className="left">
            <h2>
            Tudo o que o seu Minimercado precisa, o Blue Lite tem!
            </h2>

            <p>Minimercados têm um grande giro de produtos, muitos atendimentos e, geralmente, têm uma equipe reduzida. Desse modo, encontrar maneiras de facilitar as atividades administrativas e gerenciar <strong>produtos</strong>, <strong>estoque</strong>, vendas e contas a pagar, é essencial para o crescimento e a saúde financeira do negócio!</p>

<p>É aí que entra o <strong>Blue Lite</strong>, como a aposta de mais de 200 mil empreendedores em todo o Brasil que decidiram descomplicar a <strong>gestão empresarial</strong> e apostar em ferramentas para <strong>vender mais</strong>.</p>
          ...
          <div className="columns" ref={section1Ref}>
           ...
           <div className="column c3">
            <div className="topic">
             ...
             <p>O <strong>Blue Lite</strong> possui um Frente de Caixa para lojas dos mais diferentes segmentos, funcionando até mesmo sem internet! Nele, é possível registrar suas <strong>vendas</strong> e controlar o seu <strong>fluxo de caixa</strong> de forma rápida, prática e eficiente. E você ainda tem a facilidade de utilizar qualquer leitor de código de barras, ou ainda configurar o sistema para a leitura de <strong>etiquetas no padrão</strong> da sua balança.</p>
