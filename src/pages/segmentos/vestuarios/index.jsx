...
import Background from "../assets/image-top-sige-lite.png";
import { useState, useRef, useEffect } from "react";

import Image1 from "../assets/sistema-para-lojas-de-roupa.svg";
import Image2 from "../assets/controle-de-estoque.svg";
import Image3 from "../assets/gestao-financeira.svg";
    ...
    return (
        <S.Container data-subHeader={isOutOfView}>
         ...
         <S.Main id="myDiv">
          ...
          <div className="left">
           <h1>
           Mais que um <br /> Sistema de Gestão <br /><strong>para sua Loja de <br /> Roupas!</strong>
           ...
           <ul>
            ...
            <li>
             <GoShieldCheck size={20} color="rgb(9, 194, 9)"/>
             <p>Recursos de   <strong> Gestão e Vendas </strong> online e offline.</p>
            </li>
           </ul>
         ...
         <S.Main2>
          <div className="left">
            <h2>
            Tudo o que a sua Loja de Roupas precisa, o Blue Lite tem!
            </h2>

            <p>
              Empreender é sempre um desafio, especialmente quando se tem uma pequena empresa.
              E quando o empreendedor precisa ser <strong> multifuncional </strong>,
              nada melhor do que contar com ferramentas que ajudem a simplificar a rotina administrativa, a ter uma 
              <strong> visão ampla </strong> do negócio e, ainda, proporcionem praticidade 
              para vender e controlar as finanças. <br/><br/> É aí que entra o 
              <strong> Blue Lite </strong>, a escolha de mais de 200 mil empreendedores em todo o Brasil que decidiram
               descomplicar a gestão empresarial e apostar em ferramentas para <strong> vender mais </strong>.
            </p>
